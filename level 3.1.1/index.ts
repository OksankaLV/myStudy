...
type ConfirmationHandlingFormButton = { button: AnyButtonType, onConfirm?(param: DialogButtonType): void};
...
let buttonTwo: ConfirmationHandlingFormButton = {button: "Add", onConfirm: function (a: DialogButtonType){}};
